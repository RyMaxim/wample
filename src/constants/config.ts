export const CONFIG = {
  ...
  language: 'Wôpanâôt8âôk', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Wôpanâak Language Reclamation Project', // Put your name here so people know who made this Wordle!
  authorWebsite: 'https://www.wlrp.org/', // Put a link to your website or social media here
  ...
  normalization: 'NFKD', // whether to apply Unicode normalization to words and orthography - options: 'NFC', 'NFD', 'NKFC', 'NKFD', false
